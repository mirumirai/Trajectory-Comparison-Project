%Returns trial numbers in a cell array with 2 matrices. 1st matrix has
...
function[dataRotSorted] = sortByRotation(Data)
    ...
    %Trials are sorted into the two matrices. Since there are only 2 values for rotation
